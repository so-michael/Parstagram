...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.picture)
        //Where were going to set onClickListeners and handle and setup logic
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if(photoFile != null) {
                ...
                Toast.makeText(requireContext(), "you need to take a picture", Toast.LENGTH_SHORT).show()
            }
    ...
    fun submitPost(description: String, user: ParseUser, file: File){
        ...
        post.saveInBackground{exception ->
            if(exception != null){
                ...
                Toast.makeText(requireContext(), "Error trying to save post", Toast.LENGTH_SHORT).show()
            } else{
